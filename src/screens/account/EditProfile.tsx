      ...
      <div className="flex-1 overflow-y-auto px-4 pt-6 pb-10">
        <div className="flex flex-col items-center mb-7">
          <div className="relative">
            <div className="gp-grad w-24 h-24 rounded-full flex items-center justify-center text-[44px]">👨‍🎤</div>
            <button className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-[#27272a] border-2 border-[#09090b] flex items-center justify-center cursor-pointer">
              <MaterialIcon name="photo_camera" size={16} color="#fafafa" />
            </button>
          </div>
          <span className="text-[13.5px] text-[#c084fc] font-semibold mt-3 cursor-pointer">Change profile photo</span>
        </div>
