    ...
    >
      ...
      <div className="w-full max-w-[320px] mx-auto flex flex-col gap-3">
        ...
        <div className="flex gap-3">
          <button
            onClick={() => navigate("/app")}
            className="flex-1 h-[50px] rounded-[14px] bg-transparent border border-[#3f3f46] text-[#fafafa] text-sm font-semibold cursor-pointer font-sans flex items-center justify-center gap-2"
          >
            <span className="font-extrabold text-[#c084fc]">G</span>Google
          </button>
          <button
            onClick={() => navigate("/app")}
            className="flex-1 h-[50px] rounded-[14px] bg-transparent border border-[#3f3f46] text-[#fafafa] text-sm font-semibold cursor-pointer font-sans flex items-center justify-center gap-2"
